...
- 🔄 I specialize in legacy modernization - migrating old codebases, bridging aging tech with modern tooling, and making legacy systems work in today's world.
- 🛠️ I build across the stack - from C# backend and Go tooling to Delphi desktop apps and ESP32 firmware.
- 🖥️ Comfortable managing Linux servers and infrastructure - Docker, Bash, and Terraform are regular tools for me.
